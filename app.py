...
if not st.session_state.session_token or not validate_session(st.session_state.session_token):
    st.markdown("""
            ...
            --------------------------------------------
            🔥 เชิญเข้าร่วมกิจกรรม “จัดประลองยุทธ 2568” 🔥
            📅 ระหว่างวันที่ 18 – 23 กรกฎาคม 2568
            ใครคือ จ้าวยุทธที่แท้จริง?
            ร่วมพิสูจน์ความสามารถของคุณในสมรภูมิประลองยุทธแห่งปี!
            --------------------------------------------
            🏆 รางวัลพิเศษ
            • จ้าวยุทธอันดับ 1 – 3 จะได้รับ ฉายาพิเศษประจำปี 2568
            • เกียรติยศที่จะถูกจารึกไว้ตลอดปี!
                
            📢 ประกาศผล วันเสาร์ที่ 23 กรกฎาคม 2568 เวลา 19:00 น.
            ✅ ลงทะเบียนและเข้าร่วมการแข่งขันได้ที่
            👉 https://pricebtceth.onrender.com
                
            จ้าวยุทธอันดับ 1
            ⚔️ “เทพกระบี่คลื่นเงิน” – ผู้ฟาดฟันทุกกราฟ ดุจคลื่นทะลวงทลายแนวต้าน
                
            🥈 จ้าวยุทธอันดับ 2
            ⚔️ “มังกรกราฟผงาดฟ้า” – ผู้ครองกระแสแนวโน้ม พลิกเกมด้วยปีกมังกรแห่งการเทรด
                
            🥉 จ้าวยุทธอันดับ 3
            ⚔️ “เงากระบี่เหนือสมรภูมิ” – ผู้ว่องไวเหนือทุกจังหวะ เข้าถอนออกแม่นยำประดุจเงา
            <div class='alert-box'>⚠️ กรุณาเข้าสู่ระบบเพื่อเล่นเกม!
                ## >> เลื่อนขีด3เหลี่ยมมุมบนซ้าย</div>
            """, unsafe_allow_html=True)
    st.stop()
